/*
* The four routines for lognormal splitting
*/
#include <math.h>
#include "rpart.h"
...
int
lognormalinit(int n, double *y[], int maxcat, char **error,
...
/*
* The lognormal evaluation function.  Return the mean and the dev.
*/
void
lognormaldev(int n, double *y[], double *value, double *risk, double *wt)
{
    int i;
    double temp = 0., twt = 0., temp2 = 0., twt2 = 0.; /* sum of the weights */
    double mean, dev, mean_exp;
...
/*
 * The lognormal splitting function.  Find that split point in x such that
 ...
 */
void
lognormal(int n, double *y[], double *x, int nclass,
...
/*
 * The error function for lognormal splitting
 */
double
lognormalpred(double *y, double *yhat)
  {
